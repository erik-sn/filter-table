...
describe('filter_table_filter.test.tsx |', () => {
  describe('filterAny === true', () => {
    ...
    it('has the correct hint label (any)', () => {
      const textFieldProps: any = component.find('input').props();
      expect(textFieldProps.placeholder).to.contain('matching any filter');
    });
  ...
  describe('filterAny === false', () => {
    ...
    it('has the correct hint label (all)', () => {
      const textFieldProps: any = component.find('input').props();
      expect(textFieldProps.placeholder).to.contain('matching all filters');
    });
  });
